...
| **Dec 23–Jan 5** | - Mid-project review: summarize progress<br>- Update GitHub with code, configs, and LaTeX files | Create a short PDF report in LaTeX |
| **Jan 6–19** | - Refine ECH setup and tests<br>- Fix any test failures or server issues | Keep GitHub updated with commits |
| **Jan 20–Feb 2** | - Finalize ECH implementation on Lighttpd<br>- Automate basic tests if possible | Start organizing final report structure |
| **Feb 3–16** | - Run comprehensive tests and collect results<br>- Draft full LaTeX report | Include methodology, results, and analysis |
